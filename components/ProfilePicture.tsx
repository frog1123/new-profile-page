...
export const ProfilePicture: FC = () => {
  return (
    <div className='frog-hidden bg-[#333333] flex justify-center pt-[15px] md:pt-[30px] pb-[10px] rounded-[10px] md:rounded-[20px] border-[#b5e48c] border-[4px_0_0_0]'>
            ...
            <div className='w-[100%]'>
              <div className='relative w-[100%] h-[100%] flex justify-center align-middle'>
                <div className='z-[420] absolute w-[100%] top-[50%] transform translate-y-[-50%]'>
                  <div className='relative w-[100%] hidden sm:block h-[50px] md:h-[80px] lg:h-[100px] xl:h-[120px] border-[#b5e48c] border-[4px] rounded-[100px]'>
                    <Image src={wallpaper} layout='fill' objectFit='cover' className='rounded-[100px]' />
                  </div>
                </div>
