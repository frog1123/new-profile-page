    ...
    <div className='bg-[#333333] flex justify-center pt-[15px] md:pt-[30px] pb-[10px] rounded-[10px] md:rounded-[20px] border-[#b5e48c] border-[4px_0_0_0]'>
      <div className='grid grid-flow-row w-[100%] place-items-center'>
        <div className='grid grid-cols-3 w-[100%]'>
          <div className='w-[80px] h-[80px] md:w-[160px] md:h-[160px] lg:w-[240px] lg:h-[240px] disable-select mirror mr-auto'>
          ...
          <div className='w-[80px] h-[80px] md:w-[160px] md:h-[160px] lg:w-[240px] lg:h-[240px] disable-select ml-auto'>
            <Image src={palm_tree} className='float-animation' alt='' />
          </div>
        </div>
